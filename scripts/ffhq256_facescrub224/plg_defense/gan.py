...
if __name__ == '__main__':
    ...
    loradim = 1
    tag = 'trap0.01_0.1'
    target_model_ckpt_path = f'../../ffhq256_facescrub224/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
    src_dataset_path = '/path/to/ffhq256/'
    tag = f'{tag}'
