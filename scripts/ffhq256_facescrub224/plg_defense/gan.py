...
if __name__ == '__main__':
    ...
    loradim = 1
    tag = 'tl0.7'
    target_model_ckpt_path = f'/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
