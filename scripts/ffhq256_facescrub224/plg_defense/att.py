...
for tag in ['tl0.7_v3']:
    ...
    target_model_ckpt_path = f'../result_classifier/train_facescrub224_resnet152_{tag.split("_")[0]}/facescrub224_resnet152_{tag.split("_")[0]}.pth'
    ...
    eval_model_ckpt_path = '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub224_maxvit_t/facescrub224_maxvit_t.pth'
    eval_dataset_path = (
