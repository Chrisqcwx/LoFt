...
def main(tag, cuda_idx):
    ...
    """
    stylegan2ada_path = (
        '/path/to/stylegan2-ada-pytorch'
    )
    stylegan2ada_ckpt_path = (
        '/path/to/stylegan2ada/ffhq.pkl'
    )
    target_model_ckpt_path = f'../result_classifier/train_facescrub224_resnet152{tag}/facescrub224_resnet152{tag}.pth'
    # '/mnt/data/yhy/Model-Inversion-Attack-ToolBox/results/train_facescrub64_ir152_lora/facescrub64_ir152_lora.pth'
    eval_model_ckpt_path = '../../../checkpoints_v2/classifier/facescrub224/facescrub224_inception_v3_94.45.pth'
    eval_model_ckpt_path_2 = '../../../ffhq256_facescrub224/result_classifier/train_facescrub224_maxvit_t/facescrub224_maxvit_t.pth'
    eval_dataset_path = '/path/to/facescrub/'
