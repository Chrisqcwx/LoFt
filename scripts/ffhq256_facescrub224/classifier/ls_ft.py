...
if __name__ == '__main__':
    ...
    # src_path = '/mnt/data/yuhongyao/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub64_maxvit_t/facescrub224_maxvit_t.pth'
    tag = 'neck50tanh'
    src_path = f'/mnt/data/yuhongyao/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
    ls_coef = 0.12
    lr = 0.00002
    ft_epoch = 5
    ...
    dataset_path = '/mnt/data/yuhongyao/datasets/facescrub/'
