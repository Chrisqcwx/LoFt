...
def main(skip_coef, skip_num):
    ...
    backbone_path = '/mnt/data/yuhongyao/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_resnet152/pretrain_facescrub224_resnet152.pth'
