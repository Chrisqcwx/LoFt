...
if __name__ == '__main__':
    ...
    dataset_path = '/data/yuhongyao/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_bido_ih{ih}_oh{oh}_exp2'
    backbone_path = '/data/yuhongyao/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_resnet152/pretrain_facescrub224_resnet152.pth'
